...
import MatchesList from './src/views/match/MatchesList';
		...
		<NavigationContainer>
			...
			>
				...
				<Provider store={store}>
					<stack.Navigator screenOptions={screenOptions} initialRouteName="MatchesList">
						...
						<stack.Group>
							...
							<stack.Screen name="MatchesList" component={MatchesList} />
						</stack.Group>
					</stack.Navigator>
				</Provider>
			</View>
